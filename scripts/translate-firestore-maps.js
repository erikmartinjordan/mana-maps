...
const MAP_TRANSLATIONS = {
  ...
  'major-deserts-world': {
    ...
    featureTranslations: {
      ...
      Description: {
        'Sahara: The largest hot desert on Earth. Covers most of North Africa. Extreme temperatures can exceed 50°C. Home to sparse oasis settlements.': 'Sahara: El desierto cálido más grande de la Tierra. Cubre la mayor parte del norte de África. Temperaturas extremas que pueden superar los 50 °C. Hogar de asentamientos oásiticos dispersos.',
        'Arabian Desert: Includes the Rub\' al Khali (Empty Quarter), the largest contiguous sand body on Earth. Rich in petroleum reserves.': 'Desierto arábigo: Incluye el Rub\' al Khali (El Cuarto Vacío), la mayor masa de arena continua de la Tierra. Rico en reservas de petróleo.',
        'Gobi Desert: A cold desert spanning southern Mongolia and northern China. Part of the ancient Silk Road. Famous for dinosaur fossil discoveries.': 'Desierto de Gobi: Un desierto frío que se extiende por el sur de Mongolia y el norte de China. Parte de la antigua Ruta de la Seda. Famoso por descubrimientos de fósiles de dinosaurios.',
        'Kalahari Desert: A semi-arid sandy savanna covering much of Botswana. Home to the San people and diverse wildlife including meerkats and brown hyenas.': 'Desierto del Kalahari: Una sabana semiárida y arenosa que cubre gran parte de Botsuana. Hogar del pueblo San y una diversa fauna silvestre que incluye suricatas y chacales pardos.',
        'Patagonian Desert: The largest desert in the Americas. Formed by the Andes rain shadow. Rich in dinosaur fossils and steppe wildlife.': 'Desierto patagónico: El desierto más grande de las Américas. Formado por la sombra pluviométrica de los Andes. Rico en fósiles de dinosaurios y fauna esteparia.',
        'Great Victoria Desert: Australia\'s largest desert. Features sand dunes, grasslands, and salt lakes. A protected wilderness area.': 'Gran Desierto de Victoria: El desierto más grande de Australia. Presenta dunas de arena, praderas y lagos salados. Una área silvestre protegida.',
        'Syrian Desert: A barren plateau bridging the Fertile Crescent. Historically vital as a caravan route connecting Mesopotamia to the Mediterranean.': 'Desierto sirio: Un meseta estéril que conecta la Media Luna Fértil. Históricamente vital como ruta de caravanas que conectaba Mesopotamia con el Mediterráneo.',
        'Great Basin Desert: The largest desert in the US. Named for the enclosed drainage basins. Features sagebrush steppe and Great Salt Lake.': 'Gran Cuenca: El desierto más grande de EE.UU. Nombrado por las cuencas endorreicas. Presenta estepa de artemisa y el Gran Lago Salado.',
        'Chihuahuan Desert: The most biologically diverse desert in North America. Known for agave, yucca, and the Mexican wolf habitat.': 'Desierto de Chihuahua: El desierto con mayor biodiversidad biológica de Norteamérica. Conocido por sus agaves, yucas y el hábitat del lobo mexicano.',
        'Karakum Desert: Covers 70% of Turkmenistan. Home to the Darvaza gas crater, the \'Door to Hell,\' burning since 1971.': 'Desierto de Kara-Kum: Cubre el 70% de Turkmenistán. Hogar del cráter de gas de Darvaza, la "Puerta del Infierno", ardiendo desde 1971.',
        'Kyzylkum Desert: Located between the Amu Darya and Syr Darya rivers. The ancient Zoroastrian fire temple of Chilpyk stands in its midst.': 'Desierto de Kyzyl-Kum: Ubicado entre los ríos Amu Daria y Syr Daria. El antiguo templo zoroástrico de fuego de Chilpyk se erige en su interior.',
        'Thar Desert: The most densely populated desert in the world. Rich cultural heritage with vibrant festivals and colorful textiles.': 'Desierto de Thar: El desierto más densamente poblado del mundo. Rico patrimonio cultural con festivales vibrantes y textiles coloridos.',
        'Sonoran Desert: Known for its iconic saguaro cacti. Spans Arizona, California, and Sonora. Two rainy seasons support rich biodiversity.': 'Desierto de Sonora: Conocido por sus icónicos cactus saguaro. Se extiende por Arizona, California y Sonora. Dos temporadas de lluvias sustentan una rica biodiversidad.',
        'Antarctic Desert: The largest desert on Earth by area. Receives less than 50mm of precipitation per year. 98% covered by ice sheet averaging 2,160 m thick.': 'Desierto antártico: El desierto más grande de la Tierra por superficie. Recibe menos de 50 mm de precipitación al año. 98% cubierto por una capa de hielo de 2.160 m de espesor medio.',
        'Simpson Desert: Famous for its long parallel sand dunes, the longest parallel dunes on Earth. Named after Alfred Simpson.': 'Desierto de Simpson: Famoso por sus largas dunas de arena paralelas, las dunas paralelas más largas del mundo. Nombrado en honor a Alfred Simpson.',
      },
    }
  },
