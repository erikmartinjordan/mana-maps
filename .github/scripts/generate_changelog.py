...
:root{{
 ...
 html,body{{height:100%;background:var(--bg);color:var(--primary);overflow-x:hidden;}}
#topbar{{
...
.entry-title{{font-size:14px;font-weight:600;color:var(--primary);margin-bottom:4px;line-height:1.4;overflow-wrap:anywhere;}}
