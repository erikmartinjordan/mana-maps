...
- [ ] Re-habilitar descripciones visibles en tarjetas de la galería: quitar `display:none !important` de `.card-desc` y `.meta-source` en gallery/index.html para mostrar descripciones truncadas, mejorando SEO y descubribilidad de mapas (08-09)
