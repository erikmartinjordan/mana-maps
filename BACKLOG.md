...
- [ ] Mejorar mapa worst-wildfires-world: añadir dataSource (Global Fire Emissions Database/GFED) y dataDate, que están vacíos (auditoría 12-09)
- [ ] Añadir campo `enabled: true` a _manaLabelStyle de minimum-wage-by-country en Firestore para cumplir AGENTS.md (205 features sin enabled) (auditoría 12-09)
