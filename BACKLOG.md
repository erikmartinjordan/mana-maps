...
- [ ] Arreglar los tests que fallan tras: Nuevo mapa: "Ríos Más Largos del Mundo" con los 10 ríos principales (nacimientos y desembocaduras), usando geometrías reales de Natural Earth/ONU y publicado directamente en Firestore siguiendo el estándar de AGENTS.md (21-08)
...
- [ ] Republicar "Ríos Más Largos del Mundo" (slug `longest-rivers-world`) en Firestore: `isPublished:true`, `shareMode:'view'`, corregir `shareUrl` a `https://maña.com/gallery/?slug=longest-rivers-world`, verificar `featureCount:10` y `geojsonText` <1 MiB (26-08)
