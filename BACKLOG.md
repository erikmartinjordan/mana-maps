...
- [ ] Añadir CSS para `.card-desc` en gallery/index.html (font-size:12px, color:var(--muted), margin-top:5px, -webkit-line-clamp:2, overflow:hidden) — gallery-page.js renderiza la descripción de cada mapa pero no existe regla de estilo, el texto se desborda sin truncar (05-09)
- [ ] Nuevo mapa: "Índice de Desarrollo Humano (IDH) por País" — coropleta mundial con ~170 países, datos UNDP 2024, tags [Desarrollo,Economía,Geografía], dataSource/dataDate, legendKey/legendTitle/legendFormat, publicado en Firestore y añadido a sitemap (05-09)
