...
- [x] Añadir al sitemap.xml los 3 mapas publicados ausentes (worst-wildfires-world, submarine-fiber-cables, patrimonio-unesco-por-pais) con priority 0.6 y changefreq weekly; verificar también cobertura-forestal-por-pais (05-09) (06-09)
...
- [x] Re-habilitar descripciones y fuente de datos en tarjetas de la galería: eliminar `display:none !important` de `.meta-source` y `.card-desc` en gallery/index.html para que se vean las descripciones truncadas y la fuente/año de datos de cada mapa, mejorando SEO y credibilidad (26-09)
- [x] Actualizar JSON-LD CollectionPage de /gallery/: sincronizar `numberOfItems` y añadir los 2 mapas faltantes al itemListElement (world-happiness-world y co2-per-capita-world) (26-09)
- [x] Añadir al sitemap.xml las URLs de world-happiness-world y co2-per-capita-world con priority 0.6 y changefreq weekly (26-09)
