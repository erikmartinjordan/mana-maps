...
- [ ] Añadir legendKey/legendTitle/legendFormat a los mapas coropletas de Firestore (minimum-wage-by-country y patrimonio-unesco-por-pais) para que la leyenda del mapa destacado use la clave numérica en lugar de heurísticas frágiles (04-09)
- [ ] Publicar en Firestore el mapa de tasa de fertilidad mundial (data/fertility-rate-world.geojson, 171 países) con tags [Demografía,Población,Geografía], description y dataSource/dataDate, y añadirlo como mapa destacado rotatorio en /gallery/ (04-09)
