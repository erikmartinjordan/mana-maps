...
- [x] Verificar si cobertura-forestal-por-pais está publicado en Firestore y añadir su entrada al sitemap.xml con priority 0.6 y changefreq weekly si es así (08-09) — verificado 08-09: no publicado en Firestore (colección maps tiene 14 docs, ninguno con ese slug), sin cambios en sitemap
