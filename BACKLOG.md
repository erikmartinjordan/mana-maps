...
- [x] Añadir en la portada un bloque breve de preguntas frecuentes sobre exportación, IA y privacidad, con un enlace contextual a /pricing/ para resolver objeciones y captar búsquedas long-tail (14-08)
- [ ] Incorporar en la portada una comparación visible y concisa entre el uso gratuito y las opciones de /pricing/, con un CTA específico por beneficio
