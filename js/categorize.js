...
// ═══════════════════════════════════════════════════════════════
const PALETTES_QUAL = {
  vivid:  ['#0ea5e9','#6366f1','#10b981','#f59e0b','#ef4444','#ec4899','#8b5cf6','#f97316','#64748b'],
  pastel: ['#93c5fd','#a5b4fc','#86efac','#fde68a','#fca5a5','#fbcfe8','#c4b5fd','#fdba74','#cbd5e1'],
  earth:  ['#1e3a5f','#1e1b4b','#065f46','#78350f','#92400e','#831843','#3b0764','#7c2d12','#57534e'],
  bold:   ['#2563eb','#4f46e5','#16a34a','#d97706','#dc2626','#db2777','#9333ea','#ea580c','#64748b'],
  muted:  ['#64748b','#6b7280','#71717a','#737373','#78716c','#57534e','#525252','#44403c','#374151'],
};
const PALETTES_SEQ = {
