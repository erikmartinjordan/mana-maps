...
const I18N = {
  es: {
    ...
    topbar_chat_desc: "Reabre el asistente IA del mapa.",
    ...
    share_view_only: "Solo lectura",
    share_view_only_desc: "Copia un enlace que no permite editar a otros.",
    share_edit_mode: "Modo edición",
    share_edit_mode_desc: "Copia un enlace donde otros usuarios autenticados pueden colaborar.",
    auth_title: "Inicia sesión",
    auth_subtitle: "Guarda y comparte tus mapas.",
    ...
    template_title: "Empieza con una plantilla",
    template_subtitle: "Carga capas de ejemplo editables en lugar de partir de un mapa vacío.",
    template_trip_title: "Ruta de viaje",
    template_trip_desc: "Paradas, recorrido y zona de interés para planificar una visita.",
    template_sales_title: "Zonas comerciales",
    template_sales_desc: "Territorios de ejemplo con atributos para filtrar y categorizar.",
    template_survey_title: "Trabajo de campo",
    template_survey_desc: "Puntos de muestreo, transecto y área de estudio listos para editar.",
    template_event_title: "Evento local",
    template_event_desc: "Accesos, servicios y zonas para organizar un evento sobre el mapa.",
    template_replace_confirm: "Esta plantilla reemplazará el contenido actual. ¿Continuar?",
    ...
    hint_route_start: "Haz clic para marcar el inicio de la ruta",
    hint_route_end: "Ahora haz clic para marcar el destino",
    hint_route_confirm: "Ruta previsualizada: haz clic una vez para crearla",
    ...
    ctx_show_label: "Mostrar etiqueta",
    ctx_hide_label: "Ocultar etiqueta",
    ctx_measure_polygon: "Medir segmentos y área",
    ctx_segments: "Segmentos",
    ctx_area: "Área",
    ctx_attr_table: "Tabla de atributos",
    ctx_categorize: "Categorizar por atributo",
    label_section: "Etiquetas",
    label_enable: "Mostrar etiquetas de esta capa",
    label_field: "Campo",
    label_font: "Fuente",
    label_font_custom: "Personalizada",
    label_size: "Tamaño",
    label_color: "Color",
    label_halo_color: "Halo",
    label_halo_width: "Grosor halo",
    label_opacity: "Opacidad",
    label_offset_x: "Offset X",
    label_offset_y: "Offset Y",
    label_bold: "Negrita",
    label_italic: "Cursiva",
    label_badge: "ABC",
    // ── Layer context menu ──
    lctx_rename: "Renombrar",
    lctx_zoom: "Zoom a la capa",
    lctx_show_label: "Mostrar etiqueta",
    lctx_hide_label: "Ocultar etiqueta",
    ...
    upsell_ai_included: "Mapas en la nube",
    upsell_ai_desc: "Guarda tus mapas en tu espacio privado",
    upsell_models: "Compartir y colaborar",
    upsell_models_desc: "Enlaces privados, solo lectura o edición",
    upsell_support: "Mapas ilimitados",
    upsell_support_desc: "Supera el límite del plan gratis",
    upsell_cta: "Actualizar a Pro",
    upsell_have_key: "Seguir gratis",
    upsell_note: "El plan gratis incluye hasta 3 mapas guardados · Pro añade mapas ilimitados y opciones avanzadas de compartir",
    // ── Misc ──
    ...
    upsell_title: "Maña Maps Pro",
    upsell_period: "/ mes",
    upsell_ai_title: "Mapas en la nube",
    upsell_ai_desc: "Guarda tus mapas en tu espacio privado",
    upsell_models_title: "Compartir y colaborar",
    upsell_models_desc: "Enlaces privados, solo lectura o edición",
    upsell_support_title: "Mapas ilimitados",
    upsell_support_desc: "Supera el límite del plan gratis",
    upsell_cta: "Actualizar a Pro",
    upsell_have_key: "Seguir gratis",
    upsell_note: "El plan gratis incluye hasta 3 mapas guardados · Pro añade mapas ilimitados y opciones avanzadas de compartir",
    ...
    about_feat_layers_desc: "Vista de mapa (OpenFreeMap Positron) y vista alternativa OpenFreeMap con selector de miniaturas.",
    ...
    // ── Open metrics page ──
    open_about: "Acerca de",
    open_title: "Métricas públicas",
    open_subtitle: "Datos reales de uso de Maña Maps, actualizados en tiempo real.",
    open_hint: "Transparencia total. Sin métricas inventadas, sin vanity metrics. Lo que ves es lo que hay.",
    open_summary: "Resumen",
    open_daily_activity: "Actividad diaria",
    open_usage: "Cómo se usa",
    open_export_format: "Formato de exportación",
    open_drawing_tool: "Herramienta de dibujo",
    open_ai_provider: "Proveedor IA",
    open_footer: "Maña Maps — Hecho con ❤ en Barcelona",
    open_footer_sub: "Datos agregados desde Firebase Firestore",
    open_kpi_sessions: "Sesiones totales",
    open_kpi_exports: "Mapas exportados",
    open_kpi_ai: "Mensajes IA",
    open_kpi_features: "Features dibujadas",
    open_no_data: "Sin datos",
    open_events: "eventos",
    open_prev_month: "vs mes anterior",
    open_new: "nuevo",
    open_other: "otro",
    open_firebase_missing: "Firebase no configurado",
    open_firebase_hint: "Crea js/firebase-config.local.js",
    // ── Pricing page ──
    pricing_title: "Precios",
    pricing_subtitle: "Empieza gratis y mejora cuando necesites guardar más mapas o compartir con control.",
    pricing_free_name: "Gratis",
    pricing_free_price: "0 €",
    pricing_free_period: "para siempre",
    pricing_free_desc: "Para crear mapas rápidos sin registrarte.",
    pricing_free_feature_1: "Dibujo, medición e importación",
    pricing_free_feature_2: "Exporta a GeoJSON, KML, CSV y Shapefile",
    pricing_free_feature_3: "Hasta 3 mapas guardados",
    pricing_pro_name: "Maña Cloud Pro",
    pricing_pro_price: "4,99 €",
    pricing_pro_period: "/ mes",
    pricing_pro_desc: "Para trabajar con mapas en la nube y compartirlos con más flexibilidad.",
    pricing_pro_feature_1: "Mapas guardados ilimitados",
    pricing_pro_feature_2: "Enlaces privados, solo lectura o edición",
    pricing_pro_feature_3: "Colaboración y opciones avanzadas de compartir",
    pricing_badge: "Simple",
    pricing_trial_free: "Probar gratis",
    pricing_trial_pro: "Probar el editor gratis",
    pricing_cta_pro: "Actualizar a Pro",
    pricing_example_title: "¿Quieres verlo en acción?",
    pricing_example_text: "Explora un mapa público de ejemplo antes de elegir tu plan.",
    pricing_example_link: "Ver ejemplo en la galería →",
    pricing_note: "Sin planes complejos: usa Maña Maps gratis y activa Pro cuando tu flujo de trabajo lo pida.",
    pricing_comparison_title: "Compara los planes",
    pricing_comparison_intro: "Elige la opción que encaja con tu forma de trabajar.",
    pricing_comparison_feature: "Característica",
    pricing_comparison_maps: "Mapas guardados",
    pricing_comparison_maps_free: "Hasta 3",
    pricing_comparison_maps_pro: "Ilimitados",
    pricing_comparison_export: "Exportación",
    pricing_comparison_sharing: "Compartir con permisos",
    pricing_comparison_sharing_free: "Básico",
    pricing_comparison_collaboration: "Colaboración",
    pricing_sticky_text: "¿Listo para trabajar sin límites?",
    pricing_faq_title: "Preguntas frecuentes",
    pricing_faq_billing_question: "¿Cómo se factura Maña Cloud Pro?",
    pricing_faq_billing_answer: "Pro se cobra mensualmente mediante Stripe. El precio y los impuestos aplicables se muestran antes de confirmar el pago.",
    pricing_faq_cancel_question: "¿Puedo cancelar cuando quiera?",
    pricing_faq_cancel_answer: "Sí. Puedes cancelar la suscripción en cualquier momento y conservarás el acceso a Pro hasta el final del periodo ya pagado.",
    pricing_faq_privacy_question: "¿Qué ocurre con mis datos?",
    pricing_faq_privacy_answer: "Tus mapas guardados permanecen en tu espacio privado y solo se comparten con los permisos que elijas. El editor gratuito también funciona sin registrarte.",
    pricing_faq_free_cta: "Empezar gratis",
    pricing_faq_pro_cta: "Elegir Pro",
    pricing_plans_label: "Planes de precios",
    pricing_faq_actions_label: "Elige un plan",
  ...
  en: {
    ...
    topbar_chat_desc: "Reopen the map AI assistant.",
    ...
    share_view_only_desc: "Copy a link that does not allow others to edit.",
    share_edit_mode: "Edit mode",
    share_edit_mode_desc: "Copy a link where other signed-in users can collaborate.",
    auth_title: "Sign in",
    auth_subtitle: "Sign in to save and share your map.",
    ...
    template_title: "Start from a template",
    template_subtitle: "Load editable example layers instead of starting from an empty map.",
    template_trip_title: "Travel route",
    template_trip_desc: "Stops, itinerary, and an area of interest for planning a visit.",
    template_sales_title: "Sales territories",
    template_sales_desc: "Example territories with attributes ready to filter and categorize.",
    template_survey_title: "Field survey",
    template_survey_desc: "Sample points, a transect, and study area ready to edit.",
    template_event_title: "Local event",
    template_event_desc: "Entrances, services, and zones for organizing an event on the map.",
    template_replace_confirm: "This template will replace the current map contents. Continue?",
    ...
    hint_route_start: "Click to place the route start",
    hint_route_end: "Now click to place the destination",
    hint_route_confirm: "Preview ready: click once to create the route",
    ...
    ctx_show_label: "Show label",
    ctx_hide_label: "Hide label",
    ctx_measure_polygon: "Measure segments & area",
    ctx_segments: "Segments",
    ctx_area: "Area",
    ctx_attr_table: "Attribute table",
    ctx_categorize: "Categorize by attribute",
    label_section: "Labels",
    label_enable: "Show labels for this layer",
    label_field: "Field",
    label_font: "Font",
    label_font_custom: "Custom",
    label_size: "Size",
    label_color: "Color",
    label_halo_color: "Halo",
    ...
    lctx_show_label: "Show label",
    lctx_hide_label: "Hide label",
    ...
    // ── Upsell ──
    upsell_title: "Maña Maps Pro",
    upsell_ai_included: "Cloud maps",
    upsell_ai_desc: "Save maps to your private workspace",
    upsell_models: "Share and collaborate",
    upsell_models_desc: "Private links, view-only links, or edit access",
    upsell_support: "Unlimited maps",
    upsell_support_desc: "Move beyond the free plan limit",
    upsell_cta: "Upgrade to Pro",
    upsell_have_key: "Keep using free",
    upsell_note: "Free includes up to 3 saved maps · Pro adds unlimited maps and advanced sharing options",
    // ── Misc ──
    ...
    upsell_title: "Maña Maps Pro",
    upsell_period: "/ month",
    upsell_ai_title: "Cloud maps",
    upsell_ai_desc: "Save maps to your private workspace",
    upsell_models_title: "Share and collaborate",
    upsell_models_desc: "Private links, view-only links, or edit access",
    upsell_support_title: "Unlimited maps",
    upsell_support_desc: "Move beyond the free plan limit",
    upsell_cta: "Upgrade to Pro",
    upsell_have_key: "Keep using free",
    upsell_note: "Free includes up to 3 saved maps · Pro adds unlimited maps and advanced sharing options",
    ...
    about_feat_layers_desc: "Map view (OpenFreeMap Positron) and alternative OpenFreeMap view with thumbnail selector.",
    about_feat_dd: "Drag & Drop",
    ...
    // ── Open metrics page ──
    open_about: "About",
    open_title: "Public metrics",
    open_subtitle: "Real Maña Maps usage data, updated in real time.",
    open_hint: "Full transparency. No invented metrics, no vanity metrics. What you see is what exists.",
    open_summary: "Summary",
    open_daily_activity: "Daily activity",
    open_usage: "How it is used",
    open_export_format: "Export format",
    open_drawing_tool: "Drawing tool",
    open_ai_provider: "AI provider",
    open_footer: "Maña Maps — Made with ❤ in Barcelona",
    open_footer_sub: "Aggregated data from Firebase Firestore",
    open_kpi_sessions: "Total sessions",
    open_kpi_exports: "Exported maps",
    open_kpi_ai: "AI messages",
    open_kpi_features: "Drawn features",
    open_no_data: "No data",
    open_events: "events",
    open_prev_month: "vs previous month",
    open_new: "new",
    open_other: "other",
    open_firebase_missing: "Firebase not configured",
    open_firebase_hint: "Create js/firebase-config.local.js",
    // ── Pricing page ──
    pricing_title: "Pricing",
    pricing_subtitle: "Start free and upgrade when you need more saved maps or controlled sharing.",
    pricing_free_name: "Free",
    pricing_free_price: "€0",
    pricing_free_period: "forever",
    pricing_free_desc: "For creating quick maps without signing up.",
    pricing_free_feature_1: "Drawing, measuring and importing",
    pricing_free_feature_2: "Export to GeoJSON, KML, CSV and Shapefile",
    pricing_free_feature_3: "Up to 3 saved maps",
    pricing_pro_name: "Maña Cloud Pro",
    pricing_pro_price: "€4.99",
    pricing_pro_period: "/ month",
    pricing_pro_desc: "For working with cloud maps and sharing them with more flexibility.",
    pricing_pro_feature_1: "Unlimited saved maps",
    pricing_pro_feature_2: "Private, view-only, or edit links",
    pricing_pro_feature_3: "Collaboration and advanced sharing options",
    pricing_badge: "Simple",
    pricing_trial_free: "Try it free",
    pricing_trial_pro: "Try the editor free",
    pricing_cta_pro: "Upgrade to Pro",
    pricing_example_title: "Want to see it in action?",
    pricing_example_text: "Explore a public example map before choosing your plan.",
    pricing_example_link: "View an example in the gallery →",
    pricing_note: "No complex plans: use Maña Maps for free and activate Pro when your workflow needs it.",
    pricing_comparison_title: "Compare plans",
    pricing_comparison_intro: "Choose the option that fits the way you work.",
    pricing_comparison_feature: "Feature",
    pricing_comparison_maps: "Saved maps",
    pricing_comparison_maps_free: "Up to 3",
    pricing_comparison_maps_pro: "Unlimited",
    pricing_comparison_export: "Exporting",
    pricing_comparison_sharing: "Permission-based sharing",
    pricing_comparison_sharing_free: "Basic",
    pricing_comparison_collaboration: "Collaboration",
    pricing_sticky_text: "Ready to work without limits?",
    pricing_faq_title: "Frequently asked questions",
    pricing_faq_billing_question: "How is Maña Cloud Pro billed?",
    pricing_faq_billing_answer: "Pro is billed monthly through Stripe. The price and applicable taxes are shown before you confirm payment.",
    pricing_faq_cancel_question: "Can I cancel at any time?",
    pricing_faq_cancel_answer: "Yes. You can cancel your subscription at any time and keep Pro access until the end of the period you have already paid for.",
    pricing_faq_privacy_question: "What happens to my data?",
    pricing_faq_privacy_answer: "Your saved maps remain in your private space and are shared only with the permissions you choose. The free editor also works without signing up.",
    pricing_faq_free_cta: "Start free",
    pricing_faq_pro_cta: "Choose Pro",
    pricing_plans_label: "Pricing plans",
    pricing_faq_actions_label: "Choose a plan",
