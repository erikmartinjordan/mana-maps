...
const I18N = {
  es: {
    ...
    ctx_label_by: "Etiquetar por atributo",
    ctx_label_name_field: "Nombre del elemento",
    ctx_label_off: "Ocultar etiquetas",
    ctx_label_active: "activo",
    toast_labels_applied: "Etiquetas aplicadas",
    toast_labels_hidden: "Etiquetas ocultas",
    // ── Layer context menu ──
  ...
  en: {
    ...
    ctx_label_by: "Label by attribute",
    ctx_label_name_field: "Element name",
    ctx_label_off: "Hide labels",
    ctx_label_active: "active",
    toast_labels_applied: "Labels applied",
    toast_labels_hidden: "Labels hidden",
    // ── Layer context menu ──
    lctx_rename: "Rename",
