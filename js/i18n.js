...
const I18N = {
  es: {
    ...
    hint_route_start: "Haz clic para empezar la ruta (doble clic para terminar)",
    hint_route_end: "Sigue haciendo clic para trazar la ruta por carretera",
  ...
  en: {
    ...
    hint_route_start: "Click to start the route (double-click to finish)",
    hint_route_end: "Keep clicking to trace the road route",
