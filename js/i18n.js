...
const I18N = {
  es: {
    ...
    open_recent_events: "Eventos recientes",
    open_footer: "Maña Maps — Hecho con ❤ en Barcelona",
    open_footer_sub: "Datos en tiempo real desde Firebase Firestore",
    ...
    open_no_events: "Sin eventos recientes",
    open_events: "eventos",
  ...
  en: {
    ...
    open_recent_events: "Recent events",
    open_footer: "Maña Maps — Made with ❤ in Barcelona",
    open_footer_sub: "Real-time data from Firebase Firestore",
    ...
    open_no_events: "No recent events",
    open_events: "events",
