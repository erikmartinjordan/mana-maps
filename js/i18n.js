...
const I18N = {
  es: {
    ...
    ctx_tags: "Etiquetas",
    ctx_tags_open: "Etiquetado...",
    ctx_tags_placeholder: "Nueva etiqueta",
    ctx_tags_add: "Añadir",
    ctx_tags_empty: "Sin etiquetas todavía",
    ctx_tags_group_hint: "Se aplica a toda la capa y sus elementos",
    tag_modal_title: "Etiquetado",
    tag_modal_tags: "Etiquetas",
    tag_modal_design: "Diseño del etiquetado",
    tag_modal_element_hint: "Se aplica solo al elemento seleccionado",
    tag_style_filled: "Relleno",
    tag_style_outline: "Contorno",
    tag_style_soft: "Sutil",
    toast_tag_added: "Etiqueta añadida",
  ...
  en: {
    ...
    ctx_tags: "Tags",
    ctx_tags_open: "Tagging...",
    ctx_tags_placeholder: "New tag",
    ctx_tags_add: "Add",
    ctx_tags_empty: "No tags yet",
    ctx_tags_group_hint: "Applies to the whole layer and its elements",
    tag_modal_title: "Tagging",
    tag_modal_tags: "Tags",
    tag_modal_design: "Tag design",
    tag_modal_element_hint: "Applies only to the selected element",
    tag_style_filled: "Filled",
    tag_style_outline: "Outline",
    tag_style_soft: "Soft",
