...
const map = L.map('map', { zoomAnimation: false, zoomControl: true, worldCopyJump: true, maxBounds: [[-86, -180], [86, 180]], maxBoundsViscosity: 0.4, minZoom: 1 }).setView([40.416, -3.703], 6);
tileMap.addTo(map);
let activeBase = 'map';
