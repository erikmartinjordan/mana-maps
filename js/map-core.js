...
function renderLayers() {
  ...
  groupOrder.forEach(gid => {
    ...
    html += '  <button class="layer-group-action-btn' + ((meta.tags && meta.tags.length) ? ' has-tags' : '') + '" onclick="showLayerTagsBtn(event,\'group\',' + gid + ')" title="' + t('ctx_tags') + '">' + ICON.tag + '</button>';
